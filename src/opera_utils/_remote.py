"""Shared remote file access for Earthdata-hosted products (DISP-S1, NISAR GSLC, etc.).

Provides helpers to open remote HDF5/NetCDF files via HTTPS or S3 using
fsspec, with Earthdata Login or AWS credential authentication.
"""
...
def open_file(
    ...
    asf_endpoint : str | ASFCredentialEndpoints
